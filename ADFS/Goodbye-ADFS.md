...
* ### **セキュリティ対策をマイクロソフトに任せ、世界規模のメリットを享受**  
  ...
  AD FSを無くすことで、アタックサーフェスもなくなり、また、Azure ADの基本機能である [Smart Lockout](https://docs.microsoft.com/ja-jp/azure/active-directory/authentication/howto-password-smart-lockout) を利用することになり、パスワードスプレー等の様々な攻撃から自動的に防御されます。
